  ...
  const renderMessage = ({ item }) => {
    ...
    return (
      <View style={[styles.msgRow, isMe && styles.msgRowMe]}>
        {!isMe && <Avatar name="David M." size={32} level={3} showBadge={false} style={styles.msgAvatar} />}
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity style={styles.headerUser}>
            <Avatar name="David M." size={40} level={3} />
            <View>
              <View style={styles.nameRow}>
                <Text style={styles.headerName}>David M.</Text>
                <Text style={styles.onlineIndicator}>● online</Text>
              </View>
              <Text style={styles.headerSub}>⭐ 4.7 · Fitzroy</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity>
